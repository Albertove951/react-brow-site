...
export default class AboutMe extends Component {
    render() {
        return (
            <div  id="about-me"className="about-me-box slide-in">
            <div className="about-me-container">
                ...
                <p className="about-me-content"> 
                    ...
                    magna aliqua. Enim nulla aliquet porttitor lacus luctus. Lobortis scelerisque fermentum dui faucibus in ornare 
                    quam viverra. Pharetra vel turpis nunc eget lorem dolor sed viverra. Rhoncus mattis rhoncus urna neque viverra 
                    justo nec ultrices dui. Imperdiet massa tincidunt nunc pulvinar sapien et ligula ullamcorper malesuada. Sed arcu 
                    non odio euismod lacinia at quis risus sed. Leo a diam sollicitudin tempor id eu nisl. Tellus in metus vulputate 
                    eu scelerisque felis. Amet risus nullam eget felis eget nunc lobortis. Nisi quis eleifend quam adipiscing vitae 
                    proin sagittis nisl
                 </p>
            </div>
